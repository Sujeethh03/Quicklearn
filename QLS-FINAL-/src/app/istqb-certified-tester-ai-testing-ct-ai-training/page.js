...
export const metadata = {
  alternates: { canonical: "/istqb-certified-tester-ai-testing-ct-ai-training" },
...
const courseData = {
  ...
  "disclaimer": "ISTQB®, Certified Tester AI Testing (CT-AI)®, and all related terms are trademarks of the International Software Testing Qualifications Board (ISTQB®). All other trademarks, service marks, and registered trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
