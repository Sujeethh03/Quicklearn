  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-gray-100 px-4">
      <div className="text-center max-w-md">
        <div className="text-6xl font-bold text-[#2BA6D9] mb-4">Oops!</div>
        ...
        <div className="flex gap-4 justify-center">
          <button
            onClick={reset}
            className="bg-[#2BA6D9] hover:bg-[#1E7BA3] text-white px-6 py-3 rounded-lg font-medium transition-colors"
          >
            Try Again
          </button>
          <Link
