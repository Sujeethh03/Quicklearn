          ...
          <div className="relative">
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 p-4">
                      <span className="bg-[#2BA6D9] text-white text-xs font-semibold px-3 py-1 rounded-full">ITIL®</span>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-foundation-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-problem-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
              ...
              <div className="flex-shrink-0 w-[300px] snap-start mx-4">
                ...
                >
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent" />
                    <div className="absolute bottom-0 left-0 p-4">
                      <span className="bg-[#2BA6D9] text-white text-xs font-semibold px-3 py-1 rounded-full">SIAM</span>
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/siam-foundation-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-incident-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-service-request-management-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-monitoring-event-management-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-change-enablement-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-release-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-service-desk-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-deployment-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-it-asset-management-itam-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-continual-improvement-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-relationship-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-service-level-management-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-information-security-management-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-supplier-management-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-specialist-create-deliver-support-cds-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-specialist-drive-stakeholder-value-dsv-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-specialist-high-velocity-it-hvit-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-strategist-direct-plan-improve-dpi-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-acquiring-managing-cloud-services-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-sustainability-in-digital-it-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-business-relationship-management-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-specialist-monitor-support-fulfil-msf-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/itil-4-leader-digital-it-strategy-dits-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Link href="/siam-professional-certification-training" className="text-[#2BA6D9] hover:text-[#155A76] font-medium text-sm flex items-center">
                        Details
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
            ...
            <div className="flex justify-center mt-6 space-x-2">
              {[0, 1, 2].map((index) => (
                <button 
                  key={index}
                  className="w-2 h-2 rounded-full bg-gray-300 hover:bg-[#2BA6D9] transition-colors duration-200"
                  onClick={() => {
                    const slider = document.getElementById('itsm-slider');
      ...
      <section className="bg-slate-50 py-10 border-t border-gray-200">
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
            ITIL® is a registered trademark of PeopleCert. All rights reserved. All other trademarks, service marks, and registered trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction.
          </p>
        </div>
      </section>
