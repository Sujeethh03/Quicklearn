...
export const metadata = {
  alternates: { canonical: "/prince2-agile-practitioner-certification-training" },
...
const courseData = {
  ...
  "disclaimer": "PRINCE2®, PRINCE2 Agile®, MSP®, PeopleCert®, AXELOS®, and all related trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
