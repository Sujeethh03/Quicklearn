...
export const metadata = {
  alternates: { canonical: "/icagile-agile-coaching-icp-acc-certification-training" },
...
const courseData = {
  ...
  "disclaimer": "ICAgile®, ICP-ACC®, ICP®, and all related trademarks are the property of the International Consortium for Agile (ICAgile®). All other trademarks, service marks, and registered trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
