  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-gray-100 px-4">
      <div className="text-center max-w-lg">
        <div className="text-8xl font-bold text-[#2BA6D9] mb-4">404</div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="bg-[#2BA6D9] hover:bg-[#1E7BA3] text-white px-8 py-3 rounded-lg font-medium transition-colors text-center"
          >
            Go to Homepage
          </Link>
          <Link
