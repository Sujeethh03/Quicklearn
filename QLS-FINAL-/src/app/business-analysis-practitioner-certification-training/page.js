...
export const metadata = {
  alternates: { canonical: "/business-analysis-practitioner-certification-training" },
...
const courseData = {
  ...
  "disclaimer": "EXIN®, BCS®, Business Analysis Practice®, and all related trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
