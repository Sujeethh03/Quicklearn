...
export const metadata = {
  alternates: { canonical: "/aiops-foundation-certification-training" },
...
const courseData = {
  ...
  "disclaimer": "AIOps Foundation℠, DevOps Institute®, PeopleCert®, and all related trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
