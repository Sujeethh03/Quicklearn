...
const courseData = {
  "disclaimer": "ITIL®, ITIL® 4 Practitioner: Problem Management, PeopleCert®, AXELOS®, and all related trademarks are the property of their respective owners. QuickLearn Systems is not affiliated with, endorsed by, or sponsored by PeopleCert or AXELOS. All trademarks are acknowledged as the property of their respective owners.",
  ...
  prerequisite: [
    ...
    "Basic understanding of incident management and IT support operations",
    "Familiarity with root cause analysis techniques is beneficial",
    "Experience working in an IT service desk or operations environment is helpful"
  ],
