...
export const metadata = {
  alternates: { canonical: "/certified-scrum-product-owner-cspo-certification-training" },
...
const courseData = {
  ...
  "disclaimer": "Certified Scrum Product Owner®, CSPO®, Scrum Alliance®, Certified Scrum Trainer®, CST®, and all related trademarks are the property of Scrum Alliance. All other trademarks, service marks, and registered trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction."
};
