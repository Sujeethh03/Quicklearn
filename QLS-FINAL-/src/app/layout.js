...
<Script
  ...
  data-assistant-name="QuickLearn Systems Assistant"
  data-brand-image-url="/QLSLOGO.png"
  data-chat-icon="support"
  data-button-color="#2BA6D9"
  data-user-bg-color="#2BA6D9"
  data-assistant-bg-color="#f3f4f6"
  data-window-width="380px"
  data-window-height="500px"
  data-text-size="14"
  data-greeting="Hi! I'm your QuickLearn Systems assistant. How can I help you today?"
