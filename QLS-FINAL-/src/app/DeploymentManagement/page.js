...
const courseData = {
  "disclaimer": "ITIL®, ITIL® 4 Practitioner: Deployment Management, PeopleCert®, AXELOS®, and all related trademarks are the property of their respective owners. QuickLearn Systems is not affiliated with, endorsed by, or sponsored by PeopleCert or AXELOS. All trademarks are acknowledged as the property of their respective owners.",
  ...
  prerequisite: [
    ...
    "Basic understanding of software development, release, and deployment practices",
    "Familiarity with change management and configuration management concepts",
    "Experience in a deployment, release, or DevOps engineering role is beneficial"
  ],
