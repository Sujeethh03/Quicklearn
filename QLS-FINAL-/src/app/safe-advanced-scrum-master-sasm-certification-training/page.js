...
export const metadata = {
  alternates: { canonical: "/safe-advanced-scrum-master-sasm-certification-training" },
...
const courseData = {
  "disclaimer": "SAFe®, Scaled Agile Framework®, SAFe Scrum Master®, SAFe Advanced Scrum Master®, SASM®, and all related trademarks are the property of Scaled Agile, Inc. All other trademarks, service marks, and registered trademarks are the property of their respective owners. Any potential trademark, copyright, or content-related concerns may be reported to training@quicklearnsys.com for review and correction.",
