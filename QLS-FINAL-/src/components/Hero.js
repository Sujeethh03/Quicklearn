...
const slides = [
  ...
  {
    title: "DevOps & SRE",
    subtitle: "Bridge development and operations for faster, more reliable delivery. Master DevOps, DevSecOps, AIOps automation, CI/CD, and Site Reliability Engineering practices.",
    image: "/hero_devops_business_analysis.jpg",
    accent: "from-teal-500 to-blue-500",
  },
  {
    title: "Business Analysis",
    subtitle: "Turn business needs into effective solutions. Build the analytical, modelling, and stakeholder skills at the heart of successful change with BCS Business Analysis Foundation and Practice certifications.",
    image: "/business_analysis_foundation.jpg",
    accent: "from-amber-500 to-orange-500",
  },
  {
    title: "Software Testing",
    subtitle: "Excel in software quality assurance and testing principles. Master ISTQB Certified Tester certifications with advanced skills in test design, automation, and management.",
