    ...
    <>
      ...
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            ...
            <motion.button
              onClick={toggleChat}
              className="relative bg-[#2BA6D9] text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:shadow-xl transition-shadow"
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-[#2BA6D9] text-white px-4 py-3 flex items-center justify-between flex-shrink-0">
            ...
            <div className="flex-1 overflow-y-auto">
                  ...
                  >
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#2BA6D9]/30 focus:border-[#2BA6D9] outline-none transition-all"
                    />
                    <input
                      type="email"
                      required
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#2BA6D9]/30 focus:border-[#2BA6D9] outline-none transition-all resize-none"
                    />
                    ...
                    <button
                      ...
                      className="w-full bg-[#2BA6D9] text-white py-2.5 rounded-lg text-sm font-medium hover:bg-[#8a2626] transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
                    >
                      {emailStatus === "loading" ? (
                        <>
